...
// Query: *[_type=="sale"         && isActive == true         && couponCode == $cuponCode]        | order(validForm desc)[0]
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "*[_type==\"product\"\n        && name match $searchParams]\n        |order(name asc)": SEARCH_PRODUCTS_BY_NAME_QUERYResult;
    "*[_type==\"sale\" \n        && isActive == true \n        && couponCode == $cuponCode]\n        | order(validForm desc)[0]": ACTIVE_SALE_BY_CUPON_QUERYResult;
  }
}
