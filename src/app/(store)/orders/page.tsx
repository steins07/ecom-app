...
async function OrdersPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 p-4">
            <div className="bg-white p-4 sm:p-8 rounded-xl shadow-lg w-full max-x-4xl">
                ...
                { orders.length === 0 ?
                        (
                            ...
                            <div className="space-y-6 sm:spacey-8">
                                {orders.map((order) => (
                                    <div
                                                    ...
                                                    <div
                                                        ...
                                                        <div className="flex items-center gap-3 sm:gap-4">
                                                            {products.product?.image && (
                                                                <div className="relative h-14 w-14 sm:h-16 sm:w-16 flex-shrink-0 rounded-md overflow-hidden">
                                                                    <Image
                                                                        ...
                                                                        src={imageUrl(products.product.image).url()}
                                                                        alt={products.product.name ?? "Product Image"}
                                                                        fill
                                                                    />
                                                                </div>
                                                            )}
                                                            <div>
                                                                ...
                                                                <p className="text-sm text-gray-600">
                                                                    Quantity: {products.quantity ?? "N/A"}
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <p className="font-mediwm text-right">
                                                            {products.product?.price&& products.quantity? formatCurrency(products.product.price * products.quantity, order.currency) : "N/A"}
                                                        </p>
                                                    </div>
                                                ))}
                                            </div>
